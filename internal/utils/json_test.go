...
func TestJSONDecode_Known(t *testing.T) {
	...
	tAssertEQ(t, "NAME", sample.Name)
	tAssertEQ(t, "DeScRiPtIoN", sample.Description)
	tAssertEQ(t, "NAME", (*data).Name)
	tAssertEQ(t, "DeScRiPtIoN", (*data).Description)
}
...
func TestJSONEncode(t *testing.T) {
	...
	tAssertNil(t, err)
	tAssertEQ(t, `{"name":"NaMe","description":"DeScRiPtIoN"}`, string(jsonBytes))
}
