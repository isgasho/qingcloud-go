...
func TestLoadTemplates_0(t *testing.T) {
	fullPath, err := filepath.Abs("../testdata/fixtures/template_0")
	assert.Nil(t, err)
...
func TestLoadTemplates_1(t *testing.T) {
	fullPath, err := filepath.Abs("../testdata/fixtures/template_1")
	assert.Nil(t, err)
...
func TestLoadTemplates_2(t *testing.T) {
	fullPath, err := filepath.Abs("../testdata/fixtures/template_2")
	assert.Nil(t, err)
...
func TestLoadTemplates_3(t *testing.T) {
	fullPath, err := filepath.Abs("../testdata/fixtures/template_3")
	assert.Nil(t, err)
