...
func TestBuilder(t *testing.T) {
	...
	AssertTrue(t, strings.Contains(httpRequest.URL.String(), "https://api.qc.dev:443/iaas?"))
	AssertTrue(t, strings.Contains(httpRequest.URL.String(), "image_id.1=img-xxxxxxxx"))
	AssertTrue(t, strings.Contains(httpRequest.URL.String(), "instance_class=0"))
	AssertTrue(t, strings.Contains(httpRequest.URL.String(), "instance_type.1=type1"))
	AssertTrue(t, strings.Contains(httpRequest.URL.String(), "instances.2=i-zzzzzzzz"))
	AssertTrue(t, !strings.Contains(httpRequest.URL.String(), "limit"))
	AssertTrue(t, !strings.Contains(httpRequest.URL.String(), "offset"))
	AssertTrue(t, strings.Contains(httpRequest.URL.String(), "search_word=search_word"))
	AssertTrue(t, strings.Contains(httpRequest.URL.String(), "status.1=running"))
	AssertTrue(t, strings.Contains(httpRequest.URL.String(), "tags.1=tag1"))
	AssertTrue(t, strings.Contains(httpRequest.URL.String(), "verbose=1"))
	AssertTrue(t, strings.Contains(httpRequest.URL.String(), "zone=beta"))
}
